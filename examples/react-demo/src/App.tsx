  ...
  return (
    <div className="App" style={{ 
          ...
          <div style={{ marginBottom: '30px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                left: 0,
                height: '4px',
                backgroundColor: remainingSeconds <= 5 ? '#ff4444' : '#4CAF50',
      ...
      <footer style={{ 
        ...
        <p style={{ margin: 0 }}>
          Made with ❤️ by <a href="https://github.com/yourusername/totp-web" target="_blank" rel="noopener noreferrer">totp-web</a>
        </p>
      </footer>
    </div>
  );
